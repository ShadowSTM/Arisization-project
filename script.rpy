...
label début:
    ...
    "{b}{i}Tu quittes le labo avec [A] en coupant les ponts avec [R].{/i}{/b}"
    play sound "Click.mp3" noloop
    ...
    "{b}{i}Tu passes le tourniquet avec ta carte de lycéen.{/i}{/b}"
    play sound "Menu.mp3" noloop 

    "{b}{i}Tu attends que [A] passe elle aussi.{/i}{/b}" 
    play sound "Click.mp3" noloop
...
label rencontre: 
    ...
    E "De rien mais pour revenir à ma question [P], qui est cette fille ?"
    play sound "Click.mp3" noloop
...
label ask: 
    ...
    "Fin numéro 1 : AK-24 complétement détruite et ruinée par manque de vigilance."
    play sound "Menu.mp3" noloop
...
label yes: 
    ...
    P "Oui avec plaisir [J1]."
    play sound "Click.mp3" noloop

    J1 "Merci beaucoup."
    play sound "Click.mp3" noloop 

    P "De rien ça fais toujours plaisir d'avoir un nouveau membre."
    play sound "Click.mp3" noloop

    J1 "ok"
    play sound "Click.mp3" noloop
    
    P "Bon je vais te laisser car j'ai du boulot à faire."
    play sound "Click.mp3" noloop

    J1 "Ok alors moi je vais faire deux, trois sur mon ordi."
    play sound "Click.mp3" noloop 

    "{b}{i}Tu continues de travailler.{/i}{/b}"
    play sound "Click.mp3" noloop 
    ...
    scene clubroom
    P "bon J'ai le matériel pour paramétre [newname]."
    play sound "Click.mp3" noloop 
    ...
    "{b}{i}Puis tu installes le module pour sa nouvelle configuration mais quelque chose se produit.{/i}{/b}"
    play sound "Click.mp3" noloop 
    
    Wa "Systéme compromis par \"l'ultime hacker\", verouillage complet pour tout individu."
    play sound "Click.mp3" noloop

    P "Mince c'est quoi cette histoire. Je suis coincé pour bosser."
    play sound "Menu.mp3" noloop

    scene black 

    play music "gameover.mp3" noloop
    "{b}{i}Fin numéro 3 : Systéme d'[newname] complétement piraté et affecté par l'ultime hacker.{/i}{/b}"
...
label no: 
    ...
    scene clubroom
    show clubroom()
    P "bon J'ai le matériel pour paramétree [newname]."
    play sound "Click.mp3" noloop 
...
# second jour de cours.
    ...
    P "Sacrée Aris toujours envie d'étre déconnecter."
    play sound "Click.mp3" noloop 
    ...
    P "Hey je me suis reposé aussi je ne pense pas qu'à la programmation et ton amélioration."
    play sound "Click.mp3" noloop 
    ...
    "{b}{i}Puis soudainement tu vois tout les autres élèves à l'entrer de la salle.{/i}{/b}"
    play sound "Click.mp3" noloop 
...
label test:
    ...
    P "D'habitude tu rougis jamais comme ça."
    play sound "Click.mp3" noloop 
    ...
    I "Mais avant toute chose je n'ai pas vraiment apprécié les propos d'[J1] et [J2] envers [newname]"
    play sound "Click.mp3" noloop 
